...
本插件是为了适配「播了么」半无人直播辅助系统而开发的小红书弹幕捕获插件。它负责在小红书网页端捕获直播间互动数据，并将评论、关注、进入、点赞等事件标准化后通过 WebSocket 输出，供外部直播辅助系统接入使用。

播了么系统介绍：

https://ct4586wcq7.feishu.cn/docx/KOz8dDi8xok25IxHN3PcKrVcnHh?from=from_copylink
